...
Link(5) = struct('name','J4' , 'th',  0*ToRad, 'dz', -60, 'dy', 0, 'dx', 0, 'alf',-90*ToRad, 'az', UZ);          %3 TO 4
Link(6) = struct('name','J5' , 'th',  90*ToRad, 'dz', 0, 'dy', 0, 'dx', 30, 'alf',90*ToRad, 'az', UZ);          %4 TO 5
Link(7) = struct('name','J6' , 'th',  90*ToRad, 'dz', 0, 'dy', -30, 'dx', 0, 'alf',90*ToRad, 'az', UZ);          %5 TO 6
Link(8) = struct('name','J7' , 'th',  0*ToRad, 'dz', 40, 'dy', 0, 'dx', 0, 'alf',0*ToRad, 'az', UZ);          %6 TO 7
