...
Link(2) = struct('name','J1' , 'th',   -90*ToRad, 'dz', 0, 'dy', 50, 'dx', 0, 'alf',-90*ToRad,'az',UZ);       %1 TO 2 
Link(3) = struct('name','J2' , 'th',  -90*ToRad, 'dz', 0, 'dy', 50, 'dx', 0, 'alf',-90*ToRad,'az',UZ);    %2 TO 3
Link(4) = struct('name','J3' , 'th',  90*ToRad, 'dz', 50, 'dy', 0, 'dx', 0, 'alf',-90*ToRad,'az',UZ);          %3 TO 4
